...
#Generates bilingual dictionary given paired files and alignments
def main(argv):
	...
	with open(args.src_sents_path) as f_src, \
			open(args.trg_sents_path) as f_trg, \
			open(args.al_path) as f_al:
